 ...
 * @LastEditTime : 2025-06-16 16:16:58
 */
					...
					<div class="flex ac">
						<div class="comt-title text-center flex0 mr10">
							...
							if ($user_id) {
								...
								$comment_email = $current_commenter['comment_author_email'];
								echo '<div class="comt-avatar mb10">' . zib_get_data_avatar($comment_email) . '</div>';
							...
							<div class="comt-ctrl relative">
								...
								<div class="comt-tips-left">
									...
									if (!$user_id) {
										...
										echo '<div class="scale-placeholder">网址URL</div>';
