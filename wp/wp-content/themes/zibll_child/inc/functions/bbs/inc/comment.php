 ...
 * @LastEditTime : 2025-06-16 18:38:26
...
function zib_bbs_get_respond()
{
    ...
    //<!-- 新增私密评论 -->
    $btns_r .= '<label class="but c-blue pw-1em" data-placement="top" data-toggle="tooltip" title="你的评论仅评论双方可见。" style="margin-bottom: 0px;">';
    $btns_r .= '<input name="is-private" type="checkbox">私密</label> ';
     //<!-- 新增私密评论 -->
