...
function widget_ui_user($args, $instance)
{
    ...
    if ($instance['user_id']) {
        ...
        $cover       = $instance['show_img_bg'] ? '<div class="user-cover graphic" style="padding-bottom: 50%;"><img ' . $lazy_attr . 'src="' . _pz('user_cover_img', ZIB_TEMPLATE_DIRECTORY_URI . '/img/user_t.jpg') . '" alt="未登录默认背景"></div>' : '';
