 ...
 * @LastEditTime: 2025-09-28 22:24:57
 */
/*
 ...
 * 4.添加播放速度调整的功能，变速播放
 * 5.全屏时候，添加浏览器全屏的class
 * 6.全屏取消的时候，移除浏览器全屏的class
 */
!(function (e, t) {
        ...
        function (e, t, n) {
            ...
            var X = (function () {
                function e(t) {
                    ...
                    //添加变速-注册事件：播放速度
                    n.player.template.settingButton.addEventListener('click', function (e) {
                        //阻止默认事件
                        e.preventDefault();
                        n.toggleSetting();
                    });
                    ...
                    for (var i = 0; i < n.player.template.speedItem.length; i++) {
                        n.player.template.speedItem[i].addEventListener('click', function (e) {
                            //阻止默认事件
                            e.preventDefault();
