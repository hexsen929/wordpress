 ...
 * @LastEditTime : 2025-09-01 13:39:31
...
function zib_head_css()
{
    ...
    $var .= $opacity05 ? '--focus-color-opacity05:' . $opacity05 . ';' : '';
    $var .= $opacity3 ? '--focus-color-opacity3:' . $opacity3 . ';' : '';
    $var .= $opacity6 ? '--focus-color-opacity6:' . $opacity6 . ';' : '';
