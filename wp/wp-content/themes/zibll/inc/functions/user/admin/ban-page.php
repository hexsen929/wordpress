 ...
 * @LastEditTime: 2022-11-25 14:32:05
...
<div class="wrap">
    ...
    <div class="">
        ...
        <a class="button<?php echo $WHERE['type'] === 'ban_appeal' ? ' button-primary' : ''; ?>"
            href="<?php echo add_query_arg('type', 'ban', $page_url); ?>">禁封申诉</a>
        <a class="button<?php echo $WHERE['type'] === 'user_report' ? ' button-primary' : ''; ?>"
