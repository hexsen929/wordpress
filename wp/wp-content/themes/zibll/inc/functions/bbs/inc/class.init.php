 ...
 * @LastEditTime : 2025-08-07 21:51:17
...
class zib_bbs
{
    ...
    public function plate_columns($columns)
    {
        ...
        $columns['all_count'] = '<a href="' . add_query_arg(array('orderby' => 'posts_count', 'order' => $order)) . '"><span>' . $this->posts_name . ($order_by == 'posts_count' ? $o_icon : '') . '</span></a> · <a href="' . add_query_arg(array('orderby' => 'views', 'order' => $order)) . '"><span>热度' . ($order_by == 'views' ? $o_icon : '') . '</span></a> · <a href="' . add_query_arg(array('orderby' => 'follow_count', 'order' => $order)) . '"><span>关注' . ($order_by == 'follow_count' ? $o_icon : '') . '</span></a> · <a href="' . add_query_arg(array('orderby' => 'reply_count', 'order' => $order)) . '"><span>' . $this->comment_name . ($order_by == 'reply_count' ? $o_icon : '') . '</span></a>';
    ...
    public function posts_columns($columns)
    {
        ...
        $add_columns['all_count'] = '<a href="' . add_query_arg(array('orderby' => 'views', 'order' => $order)) . '"><span>热度' . ($order_by == 'views' ? $o_icon : '') . '</span></a> · <a href="' . add_query_arg(array('orderby' => 'score', 'order' => $order)) . '"><span>评分' . ($order_by == 'score' ? $o_icon : '') . '</span></a> · <a href="' . add_query_arg(array('orderby' => 'favorite_count', 'order' => $order)) . '"><span>收藏' . ($order_by == 'favorite_count' ? $o_icon : '') . '</span></a>';
