 ...
 * @LastEditTime : 2025-04-16 00:04:25
...
class zib_bbs_edit
{
    ...
    public static function audit($post)
    {
        ...
        if ('pending' === $post->post_status) {
            ...
            $con    = '<div class="mb20">确认批准此' . $name . '[' . $title . ']？</div><div class="muted-2-color mb10">批准后此内容将切换为<span class="badg badg-sm c-blue">已发布</span>状态</div>';
        } else {
